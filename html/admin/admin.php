...
$table .= '<table align="center" cellpadding="0" cellspacing="0" class="db-table"><tr><th></th><th>Name</th> <th>Brewery</th><th>Origin</th><th>Beer Style</th><th>ABV</th><th>IBV</th> <th>Price</th><th>On Tap</th></tr>';
...
<div style="width: 100%">
  <div class="margin">
    <form method="post">
      <input type="submit" name="beerNew" value="Add New Beer"><br><br>
    </form>
  </div>
  <?php echo $table; ?>
</div>
